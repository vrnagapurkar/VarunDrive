...
export declare var AttributeValueType: StaticSimpleSchema;
export declare var ClientIdType: StaticSimpleSchema;
export declare var ClientSecretType: StaticSimpleSchema;
export declare var PasswordType: StaticSimpleSchema;
export declare var SecretCodeType: StaticSimpleSchema;
export declare var SecretHashType: StaticSimpleSchema;
export declare var SessionType: StaticSimpleSchema;
export declare var SoftwareTokenMFAUserCodeType: StaticSimpleSchema;
export declare var TokenModelType: StaticSimpleSchema;
...
export declare var AliasAttributesListType: number;
export declare var AllowedFirstAuthFactorsListType: number;
export declare var AssetListType: StaticListSchema;
export declare var AttributeListType: StaticListSchema;
export declare var AttributeNameListType: number;
export declare var AttributesRequireVerificationBeforeUpdateType: number;
export declare var AuthEventsType: StaticListSchema;
export declare var AvailableChallengeListType: number;
export declare var BlockedIPRangeListType: number;
export declare var CallbackURLsListType: number;
export declare var ChallengeResponseListType: StaticListSchema;
export declare var ClientPermissionListType: number;
export declare var CodeDeliveryDetailsListType: StaticListSchema;
export declare var ConfiguredUserAuthFactorsListType: number;
export declare var CustomAttributesListType: StaticListSchema;
export declare var DeliveryMediumListType: number;
export declare var DeviceListType: StaticListSchema;
export declare var EventFiltersType: number;
export declare var ExplicitAuthFlowsListType: number;
export declare var GroupListType: StaticListSchema;
export declare var HttpHeaderList: StaticListSchema;
export declare var IdpIdentifiersListType: number;
export declare var ListOfStringTypes: number;
export declare var LogConfigurationListType: StaticListSchema;
export declare var LogoutURLsListType: number;
export declare var MFAOptionListType: StaticListSchema;
export declare var OAuthFlowsType: number;
export declare var ProvidersListType: StaticListSchema;
export declare var RecoveryMechanismsType: StaticListSchema;
export declare var ResourceServerScopeListType: StaticListSchema;
export declare var ResourceServersListType: StaticListSchema;
export declare var SchemaAttributesListType: StaticListSchema;
export declare var ScopeListType: number;
export declare var SearchedAttributeNamesListType: number;
export declare var SkippedIPRangeListType: number;
export declare var SupportedIdentityProvidersListType: number;
export declare var TermsDescriptionListType: StaticListSchema;
export declare var UserImportJobsListType: StaticListSchema;
export declare var UserMFASettingListType: number;
export declare var UsernameAttributesListType: number;
export declare var UserPoolClientListType: StaticListSchema;
export declare var UserPoolListType: StaticListSchema;
export declare var UserPoolTagsListType: number;
export declare var UsersListType: StaticListSchema;
export declare var VerifiedAttributesListType: number;
export declare var WebAuthnAuthenticatorTransportsList: number;
export declare var WebAuthnCredentialDescriptionListType: StaticListSchema;
export declare var AttributeMappingType: number;
export declare var AuthParametersType: StaticMapSchema;
export declare var ChallengeParametersType: number;
export declare var ChallengeResponsesType: StaticMapSchema;
export declare var ClientMetadataType: number;
export declare var LinksType: number;
export declare var ProviderDetailsType: number;
export declare var UserPoolTagsType: number;
